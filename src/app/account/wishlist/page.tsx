              ...
              <div key={p.sku} className="flex h-full flex-col">
                ...
                <div className="mt-2 grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="w-full min-h-[44px] rounded-lg border border-ink/15 px-3 py-2.5 text-center text-[11px] font-medium tracking-[0.12em] uppercase transition-colors duration-200 hover:bg-ink/5 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
